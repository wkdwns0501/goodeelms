...
👉 **[📂 발표용 PPT 및 산출물 전체 보기 (docs 폴더)](./docs/)**
...
| 항목 | 내용 |
| --- | --- |
| **테스트 플로우** | *추후 업데이트 예정 (테스트 시나리오 확정 후 기재)* |
| **GitHub 전략** | **Gitflow 전략 차용** (main + develop + feature 브랜치 운영) |
...
| 🎥 **시연 영상** | [YouTube 영상 보러가기](유튜브링크_여기에_넣으세요) |
