...
수강 신청, 강의 관리, 성적 관리, 게시판 등 대학 학사 운영을 위한 웹 플랫폼 프로젝트입니다.
...
| 이름 | 주요 기능 구현 | 비고 |
| :---: | --- | --- |
| **윤재훈** | **[수강/일정]** 수강 신청, 장바구니, 학사 일정 스케줄러, 검색 필터 구현 |  |
| **임 욱** | **[회원/재정]** 로그인, 회원가입, 학사 경고, 우등/장학/등록금 조회, 학과 정보 |  |
| **장 준** | **[강의/성적]** 마이페이지, 강의 목록, 성적 이력 조회(학생), 강의/성적 관리(교수) | **ERD 설계** |
| **최준희** | **[관리/게시판]** 게시판, 학적/장학/교원 관리, 계정 등록, 강의 평가 |  |
