				...
				<div class="row g-3 align-items-center mb-3">
				    ...
				    <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
				      ...
				      <form class="ms-lg-auto" id="lectureSearchForm" role="search">
				        <div class="input-group input-group-sm" style="max-width: 360px;">
				          ...
				          <button class="btn btn-primary" type="submit" id="btnLectureSearch" value="<c:out value='${userInput}'/>">검색</button>
				        </div>
				      </form>
				    </div>
				  </div>
				  ...
				  <div class="col-12 col-lg-4">
				    <div class="d-flex align-items-center justify-content-between gap-2">
				      <span class="text-muted small" id="remainTimeSet" data-end-time ="${endTime}" data-now-time="${nowTime}">남은 시간</span>
