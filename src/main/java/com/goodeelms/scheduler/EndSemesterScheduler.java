...
public class EndSemesterScheduler implements Job {

	@Override
	public void execute(JobExecutionContext context) throws JobExecutionException {
		System.out.println("종강 작업 실행 시간: " + LocalDateTime.now().atZone(ZoneId.of("Asia/Seoul")));
        ...
        try {
            // 로직 수행 (예: DB 상태 업데이트)
            boolean isSuccess = LectureService.getInstance().updateLectureStatusToEnd(year, semester);
